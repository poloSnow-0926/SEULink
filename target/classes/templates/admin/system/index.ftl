        ...
        <div class="row">
          ...
          <div class="col-sm-6 col-lg-3">
            <div class="card bg-success">
              <div class="card-body clearfix">
                <div class="pull-right">
                  <p class="h6 text-white m-t-0">群组总数</p>
                  <p class="h3 text-white m-b-0">${accountGroupTotal!"0"}</p>
                </div>
          ...
          <div class="col-sm-6 col-lg-3">
            <div class="card bg-primary">
              <div class="card-body clearfix">
                <div class="pull-right">
                  <p class="h6 text-white m-t-0">在线用户数</p>
                  <p class="h3 text-white m-b-0">${onlineTotal!"0"}</p>
                </div>
          ...
          <div class="col-sm-6 col-lg-3">
            <div class="card bg-purple">
              <div class="card-body clearfix">
                <div class="pull-right">
                  <p class="h6 text-white m-t-0">消息总数</p>
                  <p class="h3 text-white m-b-0">${msgLogTotal!"0"}条</p>
                </div>
