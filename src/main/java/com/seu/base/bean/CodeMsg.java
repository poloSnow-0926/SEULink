...
public class CodeMsg {
	...
	public static CodeMsg HANDLE_ERROR = new CodeMsg(-9, "操作失败，请联系管理员！");
	...
	//前台
	public static CodeMsg ACCOUNT_USERNAME_EXIST = new CodeMsg(-9001, "该用户名已存在，请换一个试试！");
	public static CodeMsg ACCOUNT_REGISTER_ERROR = new CodeMsg(-9002, "注册失败，请联系管理员！");
	public static CodeMsg ACCOUNT_USERNAME_NO_EXIST = new CodeMsg(-9003, "该用户名不存在！");
	public static CodeMsg ACCOUNT_PASSWORD_ERROR = new CodeMsg(-9004, "密码错误！");
	public static CodeMsg ACCOUNT_STATUS_ERROR = new CodeMsg(-9005, "账号已被冻结，请联系管理员！");
	public static CodeMsg ACCOUNT_HAD_DELETE = new CodeMsg(-9006, "你还不是对方好友，请先发送验证通过后再继续聊天！！");
	public static CodeMsg ACCOUNT_NO_FRIEND = new CodeMsg(-9007, "对方不是你的好友，请先添加好友再继续聊天！！");
	public static CodeMsg ACCOUNT_NO_ADMIN = new CodeMsg(-9008, "兄弟别闹，这不是你建立的群！");
	public static CodeMsg GROUP_ADMIN_NO_DELETE = new CodeMsg(-9009, "管理员不能删除！");
}
