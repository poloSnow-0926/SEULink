package com.seu.base.config.admin;
/**
 * 用来配置拦截器的配置类
 */
...
import com.seu.base.constant.RuntimeConstant;
import com.seu.base.interceptor.admin.AdminAuthorityInterceptor;
import com.seu.base.interceptor.admin.AdminLoginInterceptor;
@Configuration
